...
public class SelfTrap extends Module
{
    ...
    Setting.Boolean FULL;
    Setting.Boolean Cheap;
    ...
    public void setup() {
        ...
        this.FULL = this.registerBoolean("FULL", "full", false);
        this.Cheap = this.registerBoolean("cheap", "cheap", false);
    ...
    protected void onEnable() {
        ...
        final BlockPos centerPos = SelfTrap.mc.player.getPosition();
    ...
    @Override
    public int onUpdate() {
        if (this.sneak.getValue() && !SelfTrap.mc.gameSettings.keyBindSneak.isKeyDown()) {
            return 0;
        }
        ...
        if (this.jumpDisable.getValue() && !SelfTrap.mc.player.onGround) {
            this.disable();
            return 0;
        }
        if (!this.firstRun) {
        ...
        while (blocksPlaced < this.blocksPerTick.getValue()) {
            ...
            else if (!this.FULL.getValue()) {
                offsetPattern = Offsets.SURROUND;
                maxSteps = Offsets.SURROUND.length;
            }
            if (this.Cheap.getValue()) {
                offsetPattern = Offsets.cheap;
                maxSteps = Offsets.cheap.length;
            }
            else if (!this.Cheap.getValue()) {
                offsetPattern = Offsets.SURROUND;
                maxSteps = Offsets.SURROUND.length;
            }
            ...
            final BlockPos targetPos = new BlockPos(SelfTrap.mc.player.getPositionVector()).add(offsetPos.getX(), offsetPos.getY(), offsetPos.getZ());
    ...
    private static class Offsets
    {
        ...
        private static final Vec3d[] cheap;
        
        static {
            SURROUND = new Vec3d[] { new Vec3d(1.0, 0.0, 0.0), new Vec3d(0.0, 0.0, 1.0), new Vec3d(-1.0, 0.0, 0.0), new Vec3d(0.0, 1.0, -1.0), new Vec3d(0.0, 2.0, -1.0), new Vec3d(0.0, 2.0, 0.0), new Vec3d(1.0, 0.0, 0.0), new Vec3d(0.0, 0.0, 1.0), new Vec3d(-1.0, 0.0, 0.0), new Vec3d(0.0, 0.0, -1.0), new Vec3d(1.0, -1.0, 0.0), new Vec3d(0.0, -1.0, 1.0), new Vec3d(-1.0, -1.0, 0.0), new Vec3d(0.0, -1.0, -1.0) };
            ACB = new Vec3d[] { new Vec3d(1.0, 0.0, 0.0), new Vec3d(0.0, 0.0, 1.0), new Vec3d(-1.0, 0.0, 0.0), new Vec3d(0.0, 0.0, -1.0), new Vec3d(1.0, -1.0, 0.0), new Vec3d(0.0, -1.0, 1.0), new Vec3d(-1.0, -1.0, 0.0), new Vec3d(0.0, -1.0, -1.0), new Vec3d(1.0, 0.0, 0.0), new Vec3d(0.0, 0.0, 1.0), new Vec3d(-1.0, 0.0, 0.0), new Vec3d(0.0, 0.0, -1.0), new Vec3d(1.0, 1.0, 0.0), new Vec3d(0.0, 1.0, 1.0), new Vec3d(-1.0, 1.0, 0.0), new Vec3d(0.0, 1.0, -1.0), new Vec3d(0.0, 2.0, -1.0), new Vec3d(0.0, 2.0, 0.0) };
            cheap = new Vec3d[] { new Vec3d(1.0, 0.0, 0.0), new Vec3d(0.0, 0.0, 1.0), new Vec3d(-1.0, 0.0, 0.0), new Vec3d(0.0, 0.0, -1.0), new Vec3d(1.0, -1.0, 0.0), new Vec3d(0.0, -1.0, 1.0), new Vec3d(-1.0, -1.0, 0.0), new Vec3d(0.0, -1.0, -1.0), new Vec3d(1.0, 1.0, 0.0), new Vec3d(0.0, 1.0, 1.0), new Vec3d(-1.0, 1.0, 0.0), new Vec3d(0.0, 1.0, -1.0) };
        }
    }
}
